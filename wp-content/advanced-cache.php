...
if ( ! @file_exists( 'C:\laragon\www\wordpress\wp-content\plugins\breeze/breeze.php' ) ) { return; }
$config['config_path'] = 'C:\laragon\www\wordpress/wp-content/breeze-config/breeze-config.php';
...
if ( @file_exists( 'C:\laragon\www\wordpress\wp-content\plugins\breeze/inc/cache/execute-cache.php' ) ) {
	include_once 'C:\laragon\www\wordpress\wp-content\plugins\breeze/inc/cache/execute-cache.php';
}
