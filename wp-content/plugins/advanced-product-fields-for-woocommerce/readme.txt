    ...
    * ✅ We care about your site speed.
    ...
    There are a few limitations of the free version that you should be aware about:

    * The free version does not integrate with 3rd party plugins such as WooCommerce Subscriptions or a multi-currency plugin (unless they write an integration).
